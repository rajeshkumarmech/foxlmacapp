...
class StrategicalChitPage extends StatefulWidget {
  final String month;
  ...
  @override
  State<StrategicalChitPage> createState() => _StrategicalChitPageState();
}

class _StrategicalChitPageState extends State<StrategicalChitPage> {
