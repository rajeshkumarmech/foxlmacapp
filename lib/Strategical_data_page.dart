...
class StrategicalDataPage extends StatefulWidget {
  final String month;
  ...
  @override
  State<StrategicalDataPage> createState() => _StrategicalDataPageState();
}

class _StrategicalDataPageState extends State<StrategicalDataPage> {
