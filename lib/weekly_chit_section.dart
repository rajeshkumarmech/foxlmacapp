...
class WeeklyChitSection extends StatefulWidget {
  final String month;
  ...
  @override
  State<WeeklyChitSection> createState() => _WeeklyChitSectionState();
}

class _WeeklyChitSectionState extends State<WeeklyChitSection> {
